...
Sabrelake is attempting to end the simulation once and for all with an alarm-like device, awaking everyone inside. \
Do you help them in their goals, or do you join Lavagang in an attempt to stop them?

<h2 align="center">What is this about?</h2>
Bonestrike is a team based Fusion gamemode where one team (Sabrelake) has to hide and plant an alarm clock, \
the other team (Lavagang) has to find and defuse the alarm clock before it is too late.

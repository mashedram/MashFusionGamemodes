...
public abstract class DebugKeybind
{
    ...
    private static List<DebugKeybind> _keybinds = new();
    ...
    private static void Register()
    {
        ...
        typeof(DebugKeybind).Assembly.DefinedTypes.Where(t => t.IsSubclassOf(typeof(DebugKeybind)) && !t.IsAbstract).ToList().ForEach(t =>
        {

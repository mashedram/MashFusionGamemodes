...
public static class GlobalStatisticsCollector
{
    ...
    private static readonly SyncedDictionary<byte, PlayerStatistics> PlayerStatistics = new("syncedStatistics", new ByteEncoder(), new InstanceEncoder<PlayerStatistics>(), CommonNetworkRoutes.HostToAll);
    private static readonly RemoteEvent<StatisticChangePacket> StatisticChangeEvent = new("statisticChange", OnStatisticChangeEvent, CommonNetworkRoutes.AllToHost);
